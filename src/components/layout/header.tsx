...
import { LogIn, LogOut, User, IndianRupee, ShoppingBag, LayoutDashboard, Settings, Menu, Home, Tag, ShieldCheck, Gift } from 'lucide-react'; // Changed DollarSign to IndianRupee, Added Menu, Home, Tag etc.
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-14 items-center justify-between">
        ...
        {/* Right side: Auth actions and Mobile Menu */}
