...
import { AlertCircle, ArrowLeft, Tag, ShoppingBag, Info, ExternalLink } from 'lucide-react'; // Added Info, ExternalLink
        ...
        <div className="md:col-span-1 space-y-4 sticky top-20">
           <Card className="shadow-md border border-border overflow-hidden">
              ...
              <CardContent className="p-4 space-y-3">
                 ...
                 <Separator/>
                 {/* Optional: Add terms, cashback rates breakdown, etc. */}
